...
function Header() {
      ...
      <AppBar position="static" sx={{backgroundColor:'black'}}>
        <Toolbar>
          <IconButton
            ...
            sx={{ mr: 2 }}
          >
           <img width={'40px'} src="https://static.vecteezy.com/system/resources/thumbnails/050/700/033/small_2x/resume-flat-business-management-document-icon-illustration-png.png" />
          </IconButton>
  ...
  <IconButton>
     <Button color="inherit" className='text-light'>About Us</Button>
  </IconButton>
</Tooltip>
